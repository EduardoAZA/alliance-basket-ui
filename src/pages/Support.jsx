            ...
            <div className="w-3/5 p-5 flex flex-col justify-center gap-6">
              ...
              <Accordion type="multiple" collapsible="true" className="w-full">
                <AccordionItem value="item-1">
                  <AccordionTrigger className="text-xl">Problemas com o nosso sistema?</AccordionTrigger>
                ...
                <AccordionItem value="item-2">
                  <AccordionTrigger className="text-xl">Sugestões de melhoras?</AccordionTrigger>
                  <AccordionContent className="text-lg">
                ...
                <AccordionItem value="item-3">
                  <AccordionTrigger className="text-xl">Reclamações?</AccordionTrigger>
                  <AccordionContent className="text-lg">
              ...
              <div className="flex flex-col justify-center">
                <p className="text-lg text-meteorite-dark text-center font-semibold">Estamos de ouvidos abertos para suas dúvidas, reclamações ou sugestões. Contate-nos agora mesmo!</p>
                <div className="flex justify-center mt-4">
                  <Dialog>
                    <DialogTrigger className="bg-meteorite-dark w-1/5 p-2 rounded-md text-white font-semibold flex justify-center transition-all duration-300 hover:bg-primary">Ajuda</DialogTrigger>
                    <DialogContent>
                      <DialogHeader>
